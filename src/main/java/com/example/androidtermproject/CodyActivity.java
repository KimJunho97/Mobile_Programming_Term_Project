...
public class CodyActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View wizard = getLayoutInflater().inflate(R.layout.activity_cody, null);
        dynamicContent.addView(wizard);

        RadioGroup rg=(RadioGroup)findViewById(R.id.radioGroup1);
        RadioButton rb=(RadioButton)findViewById(R.id.cody);
        rb.setCompoundDrawablesWithIntrinsicBounds( 0,R.drawable.cody2, 0,0);
